...
namespace MetaWeblogApiWebApp.Models
{
    public class TamilRecipeValidationUtility
    {
        public TamilRecipeValidationUtility()
        {
        ...
        {
            throw new ApplicationException("Invalid recipe detail");
        }
    }
}